...
turnout app add react-demo --path examples/react-demo --env-var VITE_API_URL --server httpbin
...
- **Ping the stand** - the request goes to the app's gateway port, which
  turnout assigned when the app was added (`turnout app show react-demo` prints
